    ...
    <>
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-50 lg:hidden bg-neutral-900/90 backdrop-blur-lg border-t border-gray-800 pb-safe pt-2">
        <div className="flex items-center justify-around h-12">
          ...
          {/* Telegram */}
          <a href="https://t.me/pcshop_uzz" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center gap-1 text-xs font-medium text-gray-400 hover:text-white transition-colors">
